                            ...
                            <c:if test="${box.treelevel eq bigbox.treelevel + 1 && fn:contains(box.location, bigbox.location)}">
                                <tr align="center">
                                    <td class="alt2" width="80px">
                                        <img title="{catrow.forumrow.L_FORUM_FOLDER_ALT}" src="${initParam['imageurl']}forum_new.gif" alt="{catrow.forumrow.L_FORUM_FOLDER_ALT}" border="0" id="forum_statusicon_2">
                                    </td>
                                        ...
                                        <div class="smallfont" align="left">
                                            <div>
                                                <p class="lastposttitle">
                                                    <a href="${initParam['siteurl']}thread/${box.threadsList.get(0).postsList.get(0).threadId.id}" class="threadtitle" title="Đến bài đầu tiên chưa đọc trong chủ đề '${box.threadsList.get(0).postsList.get(0).threadId.title}'">${box.threadsList.get(0).postsList.get(0).threadId.title}</a>
                                                    <a href="${initParam['siteurl']}post/${box.threadsList.get(0).postsList.get(0).id}"><img src="${initParam['imageurl']}lastpost-right.png" alt="Đến bài cuối" title="Đến bài cuối"></a>
                                                </p>
                                                <div class="lastpostby">
                                                    bởi <div class="popupmenu memberaction" id="${box.threadsList.get(0).postsList.get(0).userId.displayName}">
                                                        <a class="username offline popupctrl" href="${initParam['siteurl']}member/${box.threadsList.get(0).postsList.get(0).userId.id}"">
                                                            ${box.threadsList.get(0).postsList.get(0).userId.displayName}
                                                        </a>
                                                    </div>
                                                </div>
                                                        <p align="right" class="lastpostdate">25-12-2015, <span class="time">22:28</span> <a href="${initParam['siteurl']}thread/${box.threadsList.get(0).postsList.get(0).threadId.id}"><img src="${initParam['imageurl']}golink.gif"></a></p>
                                            </div>
                                        </div>
                                    </td>
